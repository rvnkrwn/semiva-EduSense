...
exports.chatAI = async (req, res, next) => {
  ...
  try {
    const response = await openai.createCompletion({
      ...
      temperature: 0.5,
      // Menggunakan suhu yang lebih tinggi untuk memberikan variasi pada respons.
      max_tokens: 100,
      // Mengurangi jumlah token yang dihasilkan agar tidak terlalu panjang.
      top_p: 0.9,
      // Menggunakan top-p sampling untuk membatasi variasi jawaban.
